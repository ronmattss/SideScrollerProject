...
public class ResizablePanels : EditorWindow
{
    ...
    private void DrawUpperPanel()
    {
        ...
        DrawBox("Hello, World!", LogType.Log, true,false);
        DrawBox("ResizablePanels here!", LogType.Log, false,false);
        DrawBox("How do I look?", LogType.Warning, true,true);
    ...
    {
        lowerPanel = new Rect(0, (position.height * sizeRatio) + resizerHeight, position.width, position.height * (1 - sizeRatio));
